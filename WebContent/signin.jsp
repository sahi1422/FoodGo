...
<body class="bod">
	<div class="logbox">
		...
		<form name="myform" method="post" action="Login" onsubmit="return validations()">
			<p>Email : </p><input type="Email" required name="email" placeholder="Enter your Email here" size="50" autocomplete="off">
			<p>Password : </p><input type="Password" required name="pass" placeholder="********" size="50">
