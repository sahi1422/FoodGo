                    ...
                    <table><tbody>
					 ...
					 <div class="form-group">
					  ...
					  <input type="hidden" name="item_type" placeholder="Enter category.." value="" size="50"></td>
                            <td class="col-md-1 text-center" style="color: blue"><b><input type="text" required name=item_price readonly="readonly" value="<%=resultSet.getString("item_price") %>"></b></td>
                            <td class="col-md-2 text-center" style="color: blue;"><b><input type="submit" required name="action" value="Update"></b></td>
	    					<td class="col-md-2 text-center" style="color: blue;"><b><input type="submit" required name="action" value="Delete"></b></td>
                        </tr>                     
                    </tbody></table>
                    </form>            
            </div>
