	...
	<!-- navbar -->
		...
		<div class="logbox">				
				...
				<form name="myform" method="get" action="Add_menu" onsubmit="return validations()">
					<p>Item Name : </p><input type="text" required name="item_name" placeholder="Enter item name.." size="50" autocomplete="off">
					<p>Price : </p><input type="text" required max="5000" min="10" name="item_price" placeholder="Enter price.." size="50" autocomplete="off">
					 <p>Category : </p>
