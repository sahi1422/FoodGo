...
<body class="bod">
	<div class="logbox">
		...
		<form name="myform" method="post" action="SignUp" onsubmit="return validations()">
			<p>User Name : </p><input type="text" name="cname" placeholder="Enter your Name here" size="50" required autocomplete="off">
			<p>Email : </p><input type="email" name="cemail" placeholder="Enter your Email here" size="50" required autocomplete="off">
			<p>Contact : </p><input type="text" name="cphno" placeholder="Enter your Contact No. here" size="50" required autocomplete="off">
			<p>Password : </p><input type="Password" name="cpass" required placeholder="********" size="50">
